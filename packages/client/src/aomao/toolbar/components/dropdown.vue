...
import { dropdownProps, type DropdownListItem } from '../types'
...
export default defineComponent({
    ...
    setup(props, cxt) {
        ...
        let buttonContent = ref<DropdownListItem | { icon?: string; content?: string } | undefined>(
            undefined
        )
        ...
        const update = (values?: string | number | string[]) => {
            ...
            valuesVar.value =
                values || (props.icon || props.content ? '' : defaultItem ? defaultItem.key : '')
        }
