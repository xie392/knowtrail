    ...
    setup(props) {
                    ...
                    if (customItem) {
                        if (customItem.type === 'button') {
                            ...
                            if (customItem.onActive)
                                ...
                                customItem.values = props.engine.command.queryState(customItem.name)
                        }
        ...
        onMounted(() => {
            ...
            if (isMobile) {
                ...
                visualViewport && visualViewport.addEventListener('resize', calcuMobileView)
                visualViewport && visualViewport.addEventListener('scroll', calcuMobileView)
            } else {
        ...
        onUnmounted(() => {
            ...
            if (isMobile) {
                ...
                visualViewport && visualViewport.removeEventListener('resize', calcuMobileView)
                visualViewport && visualViewport.removeEventListener('scroll', calcuMobileView)
            } else {
                props.engine.off('readonly', updateByTimeout)
            }
        })
